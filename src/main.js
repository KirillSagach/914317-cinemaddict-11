...
const siteSectionFilms = siteMainElement.querySelector('.films');
const siteSectionFilmsList = siteMainElement.querySelector('.films-list');
render(siteSectionFilmsList, createBtnLoadMore(), 'beforeend');
