...
const createHeader = () => { return (`<h2 class="films-list__title visually-hidden">All movies. Upcoming</h2>`) };
const createHeaderTopRated = () => { return (`<h2 class="films-list__title">Top rated</h2>`) };
const createHeaderMostCommented = () => { return (`<h2 class="films-list__title">Most commented</h2>`) };
...
LastInd = siteFilmsListExtraMostCom.length - 1;
